    ...
    const sendEmail = async ( fullname, email,  password ) =>{
        ...
        try {
          const transporter =  nodemailer.createTransport({
            ...
            port:  587,
            auth: {
              user: '7fb82c001@smtp-brevo.com',
              pass: 'ZYsJ7LOKCjmXSQcB'
            }
        
            });
          const mailOptions = {
            from:'7fb82c001@smtp-brevo.com',
            to:email,
            subject: 'Welcome to SignalminigBTC',
            html: `<p>Hello  ${fullname},<br>You are welcome to SignalminigBTC, we will help you make profit from the financial market after trading. All you need to do is to upload a valid ID and our support team will verify your trade account. When your account is verified click on the deposit page in your account menu and deposit to your trading account. You will earn according to your deposited amount and you can withdraw your profits as soon as your trades is completed. Good luck and we are waiting to get testimonies from you.
      
            Please note that your deposit is with the wallet address provided by   SignalminigBTC trading Platform, do not invest to any copied wallet address or bank details provided by any account manager or third party other than that provided by SignalminigBTC, hence your deposit is invalid.<br><br>
          
            <br><br>Best Regards,
            Management<br><br>
 
            Copyright © 2021 SignalminigBTC, All Rights Reserved..<br><br>
...
const widthdrawEmail = async (  email, amount, type, narration ) =>{
    ...
    module.exports.widthdrawPage_post = async(req, res) =>{
      ...
      // Port587
      // Login7fb82c001@smtp-brevo.com
      // PasswordZYsJ7LOKCjmXSQcB
    try {
      const {id} = req.params;
      const user = await User.findById(id);
           if (user.balance === 0) {
